...
//
//import com.wjcwleklinski.worktimemanager.entity.AssignedProject;
...
//        Project project = projectRepository.findById(id).get(); // sprawdzać czy jest taki potem
//        logger.warn("tu jestem");
//        AssignedProject assignedProject = new AssignedProject(id, employee.getEmployeeId());
//
//
//
